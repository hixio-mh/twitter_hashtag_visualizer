...
function love.mousepressed(x, y, button)
  ...
  if button == 'r' then
    DISPLAY_HASHTAG = nil
    master_timer:set_time_scale(TIME_SCALE)
  end
end
...
function love.load()
  ...
  TIME_SCALE = arg[5] or 1
  TIME = tonumber(arg[6] or 210)
  GRADIENT = require('gradient1')
  SELECTED_BALL = nil
  DISPLAY_HASHTAG = nil
  MAX_RADIUS = arg[6] or 18000
...
function love.update(dt)
  ...
  if DATA_INITIALIZED then
    ...
    for i=1,#balls do
      ...
      ball.body:setLinearVelocity( 0.5 * force.x, force.y )
